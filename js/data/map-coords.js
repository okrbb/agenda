...
const MAP_DISTRICT_DATA = {
  ...
  LC: { name: 'Lučenec', area: 825.6, x: 635, y: 490, neighbors: ['VK', 'PT', 'RS', 'DT'], color: '#eab308' },
  BB: { name: 'Banská Bystrica', area: 809.4, x: 350, y: 145, neighbors: ['ZH', 'ZV', 'BR', 'DT'], color: '#f43f5e' },
  ZV: { name: 'Zvolen', area: 759.0, x: 350, y: 295, neighbors: ['BB', 'ZH', 'BS', 'KA', 'VK', 'DT'], color: '#06b6d4' },
